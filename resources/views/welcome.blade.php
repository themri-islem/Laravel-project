        ...
        <div class="parent vh-50">
            ...
            <div class="child">
                <div class="heading-block border-bottom-0" style="margin-bottom: 15px;">
                    ...
                    <h2 class="mt-3 fw-normal text-capitalize text-light white-text">le 5 et le 7 Mai 2025</h2>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row gutter-40 col-mb-80">
                ...
                <div id="desktop-description" class="postcontent col-lg-9" style="padding-bottom: 20px !important;">
                    ...
                    <p>
                        The <a class="text-decoration-underline" href="http://jurse.org/" target="_blank"><b>Joint Urban Remote Sensing Event </b></a> is a 
                       
                        est un Forum d’excellence où les chercheurs, les praticiens et les étudiants présentent,
                         partagent et discutent de leurs dernières découvertes et résultats. 
                         Une version très dynamique  organisée par Hôtel Ramada Plaza Tunis
                          en mai 2025.
                    </p>
                    ...
                    <img data-enlargeable width="100%" style="cursor: zoom-in" class="w-100 mb-4" src="img/jurse-group-photo.png" alt="">
