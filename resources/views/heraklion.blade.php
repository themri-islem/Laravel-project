     ...
     @include('nav')
        ...
        <div class="py-1">
            <div class="container">
                ...
                <div class="row mb-5">
                    <div class="col-lg-4">
                        <img src="images/crete/island.png" alt="">
                    </div>
                    <div class="col-lg-4">
                        <img src="images/crete/faistos-disc.png" alt="">
                    </div>
                    <div class="col-lg-4">
                        <img src="images/crete/koules.png" alt="">
                    </div>
                </div>
                ...
                <div class="row mb-5">
                    <div class="col-lg-4">
                        <img src="images/heraklion/titos.png" alt="">
                    </div>
                    <div class="col-lg-4">
                        <img src="images/heraklion/knossos.png" alt="">
                    </div>
                    <div class="col-lg-4">
                        <img src="images/heraklion/grypas.png" alt="">
                    </div>
                </div>
